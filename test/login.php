...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!verifyCsrfToken($_POST['csrf_token'] ?? '')) {
        ...
        $username = sanitizeString($_POST['reg_username'] ?? '');
        $email = sanitizeEmail($_POST['reg_email'] ?? '');
        $password = $_POST['reg_password'] ?? '';
        $confirmPassword = $_POST['reg_confirm_password'] ?? '';
        $firstName = sanitizeString($_POST['reg_first_name'] ?? '');
        $lastName = sanitizeString($_POST['reg_last_name'] ?? '');
